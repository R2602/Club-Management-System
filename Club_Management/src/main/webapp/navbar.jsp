...
<script>
                            ...
                            const userName${userInfo.userId} = "${userInfo.memberName}";
                            const initials${userInfo.userId} = userName${userInfo.userId}
                                .split(' ')
                                .map(part => part.charAt(0).toUpperCase())
                                .join('');
                            document.getElementById('userInitials${userInfo.userId}').textContent = initials${userInfo.userId};
                        </script>
</body>
</html>